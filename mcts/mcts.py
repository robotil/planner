#  taken with small modifications from https://gist.github.com/blole/dfebbec182e6b72ec16b66cc7e331110
#  modifications:
#  migrations to python3
#  add env.reset() after termination
import os
import gym
import sys
import random
...
class Runner:
    ...
    def run(self):
        ...
        logging.info('running enviornment {}'.format(self.env_name))
...
def main():
    ...
    os.makedirs(rec_dir)
    logging.info("rec_dir: {}".format(rec_dir))

    #control
    Runner(rec_dir, 'CartPole-v1',   loops=1000, playouts=4000, max_depth=50).run()
